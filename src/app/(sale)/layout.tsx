...
export default function SaleLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-dvh flex-col mgr-gradient-bg transition-colors duration-700" data-theme={saleTheme}>
                                ...
                                if (item.isAction) {
                                    return (
                                        <div key={item.href} className="relative w-[60px] h-[40px] flex justify-center">
                                            ...
                                            >
                                                <div className="flex h-[64px] w-[64px] items-center justify-center rounded-full bg-gradient-to-br from-teal-300 via-teal-500 to-teal-600 text-white shadow-[0_12px_24px_-4px_rgba(20,184,166,0.8),inset_0_2px_4px_rgba(255,255,255,0.4)] border border-white/60 ring-[4px] ring-teal-100/80 group-hover:shadow-[0_16px_36px_-6px_rgba(20,184,166,0.9)] transition-all">
                                ...
                                return (
                                    ...
                                    >
                                        <Icon className={cn(
                                            ...
                                            isActive ? 'h-[25px] w-[25px] stroke-[2.5px] drop-shadow-[0_2px_4px_rgba(20,184,166,0.3)]' : 'h-[23px] w-[23px] stroke-[2.5px]'
                                        )} />
                                        <span className={cn(
