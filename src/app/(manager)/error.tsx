    ...
    return (
        <div className="flex min-h-[60dvh] flex-col items-center justify-center px-4">
            <div className="text-center max-w-sm">
                ...
                <button
                    onClick={() => reset()}
                    className="flex items-center gap-2 mx-auto rounded-xl bg-indigo-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 transition-all"
                >
