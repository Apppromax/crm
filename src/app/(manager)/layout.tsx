...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-dvh flex-col mgr-gradient-bg transition-colors duration-700">
            <PrefetchPages paths={MGR_PREFETCH} />
            <main className="flex-1 pb-24 page-enter">{children}</main>

            {/* Bottom Navigation — Glass style matching Sale */}
