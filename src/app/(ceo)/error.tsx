    ...
    return (
        <div className="flex min-h-[60dvh] flex-col items-center justify-center px-4">
            <div className="text-center max-w-sm">
                ...
                <h2 className="text-lg font-bold text-slate-700 mb-1">Đã xảy ra lỗi</h2>
                <p className="text-sm text-slate-500 mb-6">
                    Có sự cố khi tải trang. Vui lòng thử lại.
                </p>
                <button
                    onClick={() => reset()}
                    className="flex items-center gap-2 mx-auto rounded-xl bg-teal-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-teal-600 transition-all"
                >
